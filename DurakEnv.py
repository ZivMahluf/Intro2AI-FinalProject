...
class DurakEnv:
    ...
    def calculate_reward(self):
        if self.turn_player.hand_size == 0:
            return 1  # maximum reward possible, cause the player won
        ...
        cards_in_hand = (len(self.turn_player.last_hand) - len(self.turn_player.hand)) / 37
...
if __name__ == '__main__':
    ...
    with tf.compat.v1.Session() as sess:
        num_games = 5000
        game = DurakEnv(
            [BasicPlayer(DurakEnv.HAND_SIZE, "Basic Player"), RandomPlayer(DurakEnv.HAND_SIZE, "Random 1"),
             RandomPlayer(DurakEnv.HAND_SIZE, "Random 2"), PPOPlayer(DurakEnv.HAND_SIZE, "PPO Player", None, sess)], False)
