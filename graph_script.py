...
def graph(dir, title, file_name, epochs=100, training_games_per_epoch=50, test_games_per_epoch_vs_test_players=500):
    cumulative_training_games_per_epoch = list(range(
        training_games_per_epoch, training_games_per_epoch * epochs, training_games_per_epoch))
...
if __name__ == '__main__':
    graph("train_against_nfsp/", "NFSP trained against another NFSP", "1.jpg")
    graph("train_against_prev_iter/", "NFSP trained against previous iterations", "2.jpg")
    graph("train_against_one_random/", "NFSP trained against random player", "3.jpg")
