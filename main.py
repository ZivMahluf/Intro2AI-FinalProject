...
def main():
    ...
    learning_player = NFSPPlayer(hand_size, "NFSP-1 Player", 'cpu')
    learning_players = [learning_player]
    learning_player2 = NFSPPlayer(hand_size, "NFSP-2 Player", 'cpu')
    learning_player2.policy = learning_player.policy
    learning_player2.current_model = learning_player.current_model
    trained_player = TrainedNFSPPlayer(hand_size, 'Trained Player')
    trained_player.load_from_other_player(learning_player)
    training_players = [learning_player2]
    test_players = [RandomPlayer(hand_size, "Random"), trained_player]
    ...
    learning_player.save_network('savedNetwork-9')
